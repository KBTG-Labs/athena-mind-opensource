...
from common.constant.domain import APP_NLU, DOMAIN_LLM, INFRA_MQ_CLIENT
...
def get_logging_config(log_level: LogLevel, log_timezone: LogTimezone):
    return  {
        ...
        "loggers": {
            "chainlit": {"handlers": ["json_handler"], "level": "INFO", "propagate": False},
            "opentelemetry": {"handlers": ["json_handler"], "level": log_level, "propagate": False},
            APP_NLU: {"handlers": ["json_handler"], "level": log_level, "propagate": False},
